...
def switcher_pointer_decoder_init(prefix, params, layer_setting):
...
def switcher_pointer_decoder_calc(prefix, params, layer_setting, h_e, mask_below, state_below, h_init = None, c_init = None, mask = None, training = True):
    ...
    return h_d, c_d, dist, alpha, switcher
